...
function contact({ hero, data }) {
  ...
  return (
    <div>
      <Hero heroData={hero} />
      <section className="dark:bg-gray-800 dark:text-gray-50 py-6">
        <div className="mx-auto grid max-w-6xl grid-cols-1 px-6 md:grid-cols-2 md:divide-x lg:px-8">
          ...
          <form
            novalidate=""
            className="ng-untouched ng-pristine ng-valid flex flex-col space-y-6 py-6 md:py-0 md:px-6"
          >
            <label className="block">
              ...
              <input
                ...
                className="focus:ring-orange-400 dark:bg-gray-800 block w-full rounded-md shadow-sm focus:ring focus:ring-opacity-75"
              />
            </label>
            <label className="block">
            ...
            <label className="block">
              ...
              <textarea
                rows="3"
                className="focus:ring-orange-400 dark:bg-gray-800 block w-full rounded-md focus:ring focus:ring-opacity-75"
              ></textarea>
            </label>
            <button
              type="button"
